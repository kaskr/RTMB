...
set_tape_config <- function(matmul = "NA", ops = "NA", math = "NA", sparse = "NA", sum = "NA", mvnorm = "NA", compare = "NA") {
    .Call(`_RTMB_set_tape_config`, matmul, ops, math, sparse, sum, mvnorm, compare)
}
