...
The random regression model could alternatively have been written using RTMBs 'tilde operator' (`%~%`):
...
But more importantly, it prevents some very common TMB mistakes, by passing `log=TRUE` automatically and making sure the sign of the objective funtion is correct.
